...
/**
 * Tests of {@link ${package}.beanbuilder.api.BeanBuilder}.
 */
...
public class BeanBuilderProcessorTest {
    ...
    public void test_Test_valid_of_third_party_bean_builder_with_doublet() {
        ...
        CompileTestBuilder
                ...
                .compilationShouldSucceed()
                .expectedJavaFileObjectExists(StandardLocation.SOURCE_OUTPUT, "${package}.processor.ObjectBuilder", JavaFileObject.Kind.SOURCE)
                .testCompilation();
    }
